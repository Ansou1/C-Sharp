...
namespace MusicSheetWriter
{
    ...
    /// </summary>
    public sealed partial class MusePage : Page
    {
        ...
        private void getListAbonne()
        {
            ...
            connect.HttpGetRequest("https://musicsheetwriter.tk/api/users/" + this.userId + "/subscriptions");
        }
        ...
        private void listViewMuse_ItemClick(object sender, ItemClickEventArgs e)
        {
        ...
        private void SearchAppBarButtonMuse_Click(object sender, RoutedEventArgs e)
        {
        ...
        private void LogoutAppBarButtonMuse_Click(object sender, RoutedEventArgs e)
        {
        HTTPRequest connect = new HTTPRequest();
