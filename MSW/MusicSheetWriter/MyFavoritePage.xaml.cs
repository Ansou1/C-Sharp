...
namespace MusicSheetWriter
{
    ...
    public sealed partial class MyFavoritePage : Page
    {
        ...
        private void getListFavouriteScore()
        {
            ...
            connect.HttpGetRequest("https://musicsheetwriter.tk/api/users/" + this.userId + "/scores/favourites");
        }
        ...
        private void listViewFavorite_ItemClick(object sender, ItemClickEventArgs e)
        {
        ...
        private void CheckBox_Click(object sender, RoutedEventArgs e)
        {
            ...
            System.Diagnostics.Debug.WriteLine("Affichage donnée score my favourite => " + score.Id + " " + score.Title);
            if (s.IsChecked == true)
